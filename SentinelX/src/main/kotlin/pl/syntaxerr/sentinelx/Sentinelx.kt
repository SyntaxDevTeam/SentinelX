package pl.syntaxerr.sentinelx
 ...
 */
@Plugin("sentinelx")
class Sentinelx @Inject constructor(
    ...
    fun onConstructPlugin(event: ConstructPluginEvent) {
        ...
        this.logger.info("Constructing sentinelx")
    }
    ...
    fun onRegisterCommands(event: RegisterCommandEvent<Command.Parameterized>) {
        ...
        event.register(this.container,
            Command.builder().addParameter(nameParam).permission("sentinelx.command.greet").executor { ctx ->
